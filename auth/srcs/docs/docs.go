...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/admin/integrations/42/users/{login}": {
            "get": {
    ...
    "definitions": {
        ...
        "core.Campus42": {
            ...
            "properties": {
                ...
                "language": {
                    "$ref": "#/definitions/core.CampusLang42"
                },
                "name": {
                    "type": "string"
                },
        ...
        "core.Image42": {
            ...
            "properties": {
                ...
                "versions": {
                    "$ref": "#/definitions/core.ImageVersions42"
                }
            }
        },
        "core.ImageVersions42": {
            "type": "object",
            "properties": {
                "large": {
                    "type": "string"
        ...
        "core.ProjectUser42": {
            ...
            "properties": {
                ...
                "project": {
                    "$ref": "#/definitions/core.Project42"
                },
                "retriable_at": {
                    "type": "string"
                },
                "status": {
                    "description": "e.g., in_progress, finished, searching_a_group",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "core.User42": {
            ...
            "properties": {
                "achievements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Achievement42"
                    }
                },
                "active?": {
                    "type": "boolean"
                ...
                "campus": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Campus42"
                    }
                },
                "campus_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.CampusUser42"
                    }
                },
                "correction_point": {
                    "type": "integer"
                ...
                "cursus_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.CursusUser42"
                    }
                },
                "data_erasure_date": {
                    "type": "string"
                ...
                "expertises_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.ExpertiseUser42"
                    }
                },
                "first_name": {
                    "type": "string"
                ...
                "languages_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.LanguageUser42"
                    }
                },
                "last_name": {
                    "type": "string"
                ...
                "patroned": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Patroned42"
                    }
                },
                "patroning": {
                    "type": "array",
                ...
                "projects_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.ProjectUser42"
                    }
                },
                "roles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Role42"
                    }
                },
                "staff?": {
                    "type": "boolean"
                ...
                "titles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Title42"
                    }
                },
                "titles_users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.TitleUser42"
                    }
                },
                "updated_at": {
                    "type": "string"
